...
(function(window) {
	...
	**/
	p.pointAt = function(pos, at, up) {
		...
		y.normalize();
		var mtx = new Matrix3D([x.x, x.y, x.z, 0, y.x, y.y, y.z, 0, z.x, z.y, z.z, 0, 0, 0, 0, 1]);
		this.append(mtx);
	};
	...
	* private method
	**/
	p._multiplication = function(m1, m2) {
		var rd1 = m1.rawData;
